...
**Not:**
Sadece Yardımcı Kullanıcılar için.  
...
async def useradd(_, message: Message):
    if not message.reply_to_message:
        ...
        if added:
            await message.reply_text(
                f"Eklendi **{user.mention}** bahsedin."
            )
